 ...
 * @Author:pk$
 */
public class FragmentGouWu extends BaseFragment<HomeFragmentPresenter> implements HomeFragmentView {
    ...
    protected void initView() {
        seeMemberText1.setText("尊享全员购物节");
...
//                }
    ...
    protected void loadData() {
        wvWeb.loadUrl("http:h5.jealook.com/vinnlook/vip5.html");
    }
