 ...
 * @Author:pk$
 */
public class BrowseAdapter extends BaseStateAdapter<BrowseListBean.ListBean, BrowseAdapter.BrowseHolder> {
    Context context;
    ...
    @Override
    protected BrowseHolder getViewHolder(@NonNull ViewGroup parent, int holderType) {
        return new BrowseHolder(inflate(parent, R.layout.classifylist_item));
    }

    class BrowseHolder extends BaseHolder<BrowseListBean.ListBean> {

        ImageView classify_img;
        TextView classify_name;
        TextView classify_price, classify_supi;

        BrowseHolder(View itemView) {
            super(itemView);
        ...
        @Override
        public void bindData(BrowseListBean.ListBean data) {
