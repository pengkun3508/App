 ...
 * @Author:pk$
 */
public class RecommendAdapter extends BaseStateAdapter<TypeGoodsBean.ListBean, RecommendAdapter.RecommendHolder> {
    ...
    class RecommendHolder extends BaseHolder<TypeGoodsBean.ListBean> {
        ...
        @Override
        public void bindData(TypeGoodsBean.ListBean data) {
