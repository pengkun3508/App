 ...
 */
public abstract class BaseStateAdapter4<E, H extends BaseHolder<E>> extends RecyclerView.Adapter<BaseHolder<E>> {
    ...
    protected int getEmptyLayoutId() {
        return R.layout.rv_item_state_empty_2;
    }
...
//        GifImageView ivEmpty = holder.getView(R.id.iv_rv_item_state_empty1);
//        if (ivEmpty != null) {
