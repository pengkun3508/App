...
public class PictureSelectorHelper {
    ...
    private PictureSelectorHelper(Activity activity, int requestCode, List<LocalMedia> selectList) {
        mSelector = PictureSelector.create(activity);
        mRequestCode = requestCode;
    ...
    @NonNull
    public static PictureSelectorHelper with(Activity activity, int requestCode, List<LocalMedia> selectList) {
        return new PictureSelectorHelper(activity, requestCode, selectList);
    }
