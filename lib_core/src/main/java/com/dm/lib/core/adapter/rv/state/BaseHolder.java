...
public abstract class BaseHolder<E> extends RecyclerView.ViewHolder {
     ...
     * @param data E
     */
    public abstract void bindData(E data);

    public final void setOnItemClickListener(final OnClickListener onItemClickListener) {
    ...
    public final void setOnViewClickListener(SparseArray<OnClickListener> onViewClickListeners) {
