 ...
 * @Author:pk$
 */
public class ExpressList_1Adapter extends BaseStateAdapter<ConfirmOrderBean.ZyShopListBean.WaybillListBean, ExpressList_1Adapter.ExpressListListHolder> {

    Context context;

    public ExpressList_1Adapter(Context contexts) {
        context = contexts;
    }
    ...
    class ExpressListListHolder extends BaseHolder<ConfirmOrderBean.ZyShopListBean.WaybillListBean> {
        ...
        @Override
        public void bindData(ConfirmOrderBean.ZyShopListBean.WaybillListBean data) {
