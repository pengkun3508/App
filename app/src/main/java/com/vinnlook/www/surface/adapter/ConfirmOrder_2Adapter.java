 ...
 * @Author:pk$
 */
public class ConfirmOrder_2Adapter extends BaseStateAdapter<ConfirmOrderBean.HtShopListBean.ShopListBeanX, ConfirmOrder_2Adapter.ConfirmOrderHolder> {
    ...
    class ConfirmOrderHolder extends BaseHolder<ConfirmOrderBean.HtShopListBean.ShopListBeanX> {
        ...
        @Override
        public void bindData(ConfirmOrderBean.HtShopListBean.ShopListBeanX data) {
