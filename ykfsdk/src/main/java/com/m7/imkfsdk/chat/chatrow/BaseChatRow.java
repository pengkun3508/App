...
//                                .into(baseHolder.getChattingAvatar());
                        ...
                        Glide.with(context)
                                .asBitmap()
                                .load(systemMsgLogo + "?imageView2/0/w/100/h/100")
                                .apply(new RequestOptions()
                                        .placeholder(R.drawable.kf_head_default_local)
                                        .error(R.drawable.kf_head_default_local)
                                )
                ...
                SharedPreferences spDatas = context.getSharedPreferences("moordata", 0);
//                baseHolder.getChattingAvatar().setImageResource(R.drawable.kf_head_default_local);
                baseHolder.getChattingAvatar().setScaleType(ImageView.ScaleType.FIT_XY);
                Glide.with(context)
                        .asBitmap()
                        .load(spDatas.getString(Constants.HEADURL, ""))
