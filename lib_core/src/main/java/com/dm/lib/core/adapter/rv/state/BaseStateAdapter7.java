 ...
 */
public abstract class BaseStateAdapter7<E, H extends BaseHolder<E>> extends RecyclerView.Adapter<BaseHolder<E>> {
    ...
    protected int getEmptyLayoutId() {
        return R.layout.rv_item_state_empty_7;
    }
    ...
    protected void bindEmptyData(@NonNull BaseHolder<E> holder) {
        ...
        if (mOnEmptyViewClickListener != null) {
            LinearLayout llEmpty = holder.getView(R.id.ll_rv_item_state_empty);
            if (llEmpty != null) {
        ...
        ImageView ivEmpty = holder.getView(R.id.iv_rv_item_state_empty);
        if (ivEmpty != null) {
        ...
        TextView tvEmpty = holder.getView(R.id.tv_rv_item_state_empty);
        if (tvEmpty != null) {
            String text = getDefaultEmptyText();
    ...
    protected int getDefaultEmptyIcon_1() {
        return R.mipmap.shop_car_icon;
    }
