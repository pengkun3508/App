...
public class MTextView extends View {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.MTextView_paddingLeft, 0);
        mPaddingRight = typedArray.getDimensionPixelSize(R.styleable.MTextView_paddingRight, 0);
        mPaddingTop = typedArray.getDimensionPixelSize(R.styleable.MTextView_paddingTop, 0);
        mPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.MTextView_paddingBottom, 0);

        mText = typedArray.getString(R.styleable.MTextView_text);
        textColor = typedArray.getString(R.styleable.MTextView_textColor);
        if (textColor == null) {
            textColor = "#000000";
        }
        textSize = typedArray.getDimensionPixelSize(R.styleable.MTextView_textSize, 50);
        lineSpace = typedArray.getInteger(R.styleable.MTextView_lineSpacings, 0);
        typedArray.recycle();
    }
