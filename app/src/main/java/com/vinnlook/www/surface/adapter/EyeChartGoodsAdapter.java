 ...
 * @Author:pk$
 */
public class EyeChartGoodsAdapter extends BaseStateAdapter<EyeChartDetailsBean.GoodsListBean, EyeChartGoodsAdapter.EyeChartGoodsHolder> {

    Context context;


    public EyeChartGoodsAdapter(Context context) {
        super();
    ...
    @Override
    protected EyeChartGoodsHolder getViewHolder(@NonNull ViewGroup parent, int holderType) {
        return new EyeChartGoodsHolder(inflate(parent, R.layout.article_goods_item));
    }

    class EyeChartGoodsHolder extends BaseHolder<EyeChartDetailsBean.GoodsListBean> {
        ...
        EyeChartGoodsHolder(View itemView) {
            super(itemView);
