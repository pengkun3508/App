...
public class ChatActivity extends MyBaseActivity implements OnClickListener,
    ...
    public void handleMessage(Message msg, StringBuilder fullResult) {
        Log.e("handleMessage", "==状态码==" + msg.what);
        if (msg.what == HANDLER_MSG) {
            ...
            other_name_static.setText("客服在线");
            //当前是机器人
            ...
            other_name_static.setText("客服离线");
...
//            }
    ...
    class KeFuStatusReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.e("客服状态接收器", "==KeFuStatusReceiver==" + action);
            if (IMChatManager.ROBOT_ACTION.equals(action)) {
                ...
                other_name_static.setText("客服在线");
                //客服信息
                String type = intent.getStringExtra(IMChatManager.CONSTANT_TYPE);//类型
                String exten = intent.getStringExtra(IMChatManager.CONSTANT_EXTEN);//工号
                String userName = intent.getStringExtra(IMChatManager.CONSTANT_USERNAME);//客服名称
                String userIcon = intent.getStringExtra(IMChatManager.CONSTANT_USERICON);//客服头像
