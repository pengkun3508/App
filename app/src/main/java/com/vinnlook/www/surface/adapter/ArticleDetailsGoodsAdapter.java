 ...
 * @Author:pk$
 */
public class ArticleDetailsGoodsAdapter extends BaseStateAdapter<ArticleDetailsBean.GoodsListBean, ArticleDetailsGoodsAdapter.ArticleDetailsGoodsHolder> {

    Context context;
    ApplyListAdapter.ApplyListClickListener applyListClickListener;

    public ArticleDetailsGoodsAdapter(Context context) {
        super();
    ...
    @Override
    protected ArticleDetailsGoodsHolder getViewHolder(@NonNull ViewGroup parent, int holderType) {
        return new ArticleDetailsGoodsHolder(inflate(parent, R.layout.article_goods_item));
    }
    ...
    class ArticleDetailsGoodsHolder extends BaseHolder<ArticleDetailsBean.GoodsListBean> {
        ...
        ArticleDetailsGoodsHolder(View itemView) {
            super(itemView);
        ...
        public void bindData(ArticleDetailsBean.GoodsListBean data) {
            ...
            article_goods_item_fuhao.setText(Html.fromHtml("&yen"));
