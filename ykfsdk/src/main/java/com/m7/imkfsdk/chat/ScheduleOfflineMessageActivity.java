        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < childSize; i++) {
                    ...
                    if (required) {
                        if ("".equals(value)) {
                            Toast.makeText(ScheduleOfflineMessageActivity.this, fieldName + getString(R.string.ykf_please_required), Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                    datas.put(id, value);
                ...
                if (!"".equals(content)) {
                    ...
                    IMChatManager.getInstance().submitOfflineMessage(ToPeer, content, datas, lmfList, new OnSubmitOfflineMessageListener() {
                        ...
                        public void onSuccess() {
                            ...
                            Toast.makeText(ScheduleOfflineMessageActivity.this, getString(R.string.ykf_up_leavemessageok), Toast.LENGTH_SHORT).show();
                            finish();
                        }
                        ...
                        public void onFailed() {
                            loadingFragmentDialog.dismiss();
                            Toast.makeText(ScheduleOfflineMessageActivity.this, getString(R.string.ykf_up_leavemessage_fail), Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });

                } else {
                    Toast.makeText(ScheduleOfflineMessageActivity.this, getString(R.string.ykf_put_edit), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
