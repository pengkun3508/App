...
public class ViewUtils {
     ...
     */
    public static void divideEditTextWithGroup(@NonNull EditText editText, @IntRange(from = 1) int groupCount, @NonNull char separator) {
                ...
                if (!"".equals(s.toString()) && !".".equals(s.toString())) {
                    if (!"".equals(s.toString()) && !".".equals(s.toString())) {
                        if (Float.valueOf(s.toString()) > allMoney) {
                            ...
                            setEditTextWithSelection(editText, String.valueOf(allMoney));
                        }
                    }
                }
            }
    ...
    public static void setEditTextWithSelection(EditText editText, CharSequence text) {
    ...
    public static void bindEditTextAndSubmitWithNotEmpty(final View submitView, final EditText... editTexts) {
