 ...
 * @Author:pk$
 */
public class FragmentZheKou extends BaseFragment<HomeFragmentPresenter> implements HomeFragmentView {
    ...
    protected void initView() {
        seeMemberText1.setText("尊享全场95折");
...
//                }
    ...
    protected void loadData() {
        wvWeb.loadUrl("http:h5.jealook.com/vinnlook/vip1.html");
    }
