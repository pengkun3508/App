...
public class CustomText extends AppCompatTextView {
    ...
    public CustomText(Context context, AttributeSet attrs) {
        ...
        showTime = typedArray.getInteger(R.styleable.LinearGradientTextView4_showTime, 80);
        lineNumber = typedArray.getInteger(R.styleable.LinearGradientTextView4_lineNumber, 1);
        showStyle = typedArray.getInt(R.styleable.LinearGradientTextView4_showStyle, TWOWAY);
        color = typedArray.getColor(R.styleable.LinearGradientTextView4_textColors, getResources().getColor(R.color.coupon_text1));
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int gradientSize = (int) (10 * textWidth / text.length());
//        int gradientSize = (int) (text.length());
        //边缘融合
